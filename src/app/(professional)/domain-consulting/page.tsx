            ...
            <div className="col-lg-5">
              <div className="rounded-3xl overflow-hidden h-[320px] md:h-[380px]">
                <Image
                  ...
                  alt="Domain consulting overview"
                  width={0}
                  height={0}
                  sizes="100vw"
            ...
            {[
              {
                ...
                text: 'Financial services, healthcare, manufacturing, and retail—with cross‑industry patterns.',
              },
              {
                icon: 'fas fa-scale-balanced',
                title: 'Pragmatic Governance',
                text: 'Controls mapped to PCI, SOX, HIPAA, ISO—right‑sized to your risk profile.',
              },
              {
                icon: 'fas fa-sitemap',
                title: 'Executable Architecture',
                text: 'Reference architectures, integration patterns, and data contracts that scale.',
              },
              {
                icon: 'fas fa-handshake',
                title: 'Co‑Delivery Model',
                text: 'Work side‑by‑side with your SMEs and leaders to de‑risk change.',
              },
            ].map((card, i) => (
              <div key={i} className="col-lg-3 col-md-6">
                <div className="bento-card text-center rounded-2xl border border-zinc-200 bg-white p-6 h-100">
                  <div className="icon text-2xl text-[var(--theme)]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-4">
            <div className="bento-card relative overflow-hidden rounded-2xl border border-zinc-200 p-6 md:col-span-2">
              <div className="absolute inset-0 -z-20">
                <Image
                  src="/assets/img/domain-consulting/invest-roadmap.webp"
                  alt=""
                  fill
                  sizes="100vw"
              ...
              <div className="absolute inset-0 -z-10 bg-gradient-to-t from-[var(--theme)]/80 to-[var(--foreground)]/50 hover:to-[var(--foreground)]/90 transition-all duration-700"></div>
              <h3 className="text-xl font-semibold text-white">Industry Strategy & Operating Model</h3>
              <p className="mt-2 text-zinc-50">
                Target operating model, capability map, and investment roadmap linked to business
                outcomes.
              </p>
            </div>
            <div className="bento-card rounded-2xl border border-zinc-200 bg-white p-6">
              <h3 className="text-xl font-semibold text-zinc-900">Regulatory & Risk Advisory</h3>
              <p className="mt-2 text-zinc-600">
                Pragmatic controls mapped to your frameworks (PCI, SOX, HIPAA, ISO).
              </p>
              <div className="mt-4 rounded-xl overflow-hidden h-[140px] md:h-[160px] relative">
                <Image
                  src="/assets/img/domain-consulting/risk.webp"
                  alt="Regulatory and risk advisory"
                  fill
            ...
            <div className="bento-card rounded-2xl border border-zinc-200 bg-white p-6">
              <h3 className="text-xl font-semibold text-zinc-900">Domain Architecture</h3>
              <p className="mt-2 text-zinc-600">
                Reference architectures, integration patterns, and data contracts that scale.
              </p>
              <div className="mt-4 rounded-xl overflow-hidden h-[140px] md:h-[160px] relative">
                <Image
                  src="/assets/img/domain-consulting/domain-arch.webp"
            ...
            <div className="bento-card relative overflow-hidden rounded-2xl border border-zinc-200 p-6 md:col-span-2">
              <div className="absolute inset-0 -z-20">
                <Image
                  src="/assets/img/domain-consulting/stakeholders.webp"
                  alt=""
                  fill
                  sizes="100vw"
                  style={{ objectFit: 'cover' }}
              ...
              <div className="absolute inset-0 -z-10 bg-gradient-to-t from-[var(--theme)]/80 to-[var(--foreground)]/50 hover:to-[var(--foreground)]/90 transition-all duration-700"></div>
              <h3 className="text-xl font-semibold text-white">Change & Enablement</h3>
              <p className="mt-2 text-zinc-50">
                Stakeholder alignment, training, and adoption plans to land the change.
              </p>
            </div>
          </div>
        </div>
            ...
            {[
              {
                icon: 'fas fa-search',
                title: 'Discover',
                text: 'Stakeholder interviews, KPI baselining, risk & compliance constraints.',
              },
              {
                icon: 'fas fa-drafting-compass',
                title: 'Design',
                text: 'Target operating model, capability map, and executable roadmap.',
              },
              {
                icon: 'fas fa-rocket',
                title: 'Deliver',
                text: 'Co‑delivery with your SMEs; sprints, playbooks, and handover.',
              },
              {
                icon: 'fas fa-chart-line',
                title: 'Optimize',
                text: 'Benefits tracking, KPI reviews, and continuous improvement.',
              },
            ].map((m, i) => (
              <div key={i} className="col-lg-3 col-md-6">
                <div className="rise-card bento-card text-center rounded-2xl border border-zinc-200 bg-white p-6 h-100">
                  ...
                  <h4 className="mt-2">{m.title}</h4>
                  <p className="text-zinc-600 text-sm">{m.text}</p>
                </div>
              </div>
            ))}
          </div>
              ...
              <div className="faq-accordion">
                <details open>
                  ...
                  <div className="answer">
                    Financial services, healthcare & life sciences, manufacturing & supply chain,
                    and retail—plus cross‑industry transformations.
                  </div>
                </details>
                <details>
                  <summary className="break-words">
                  ...
                  <div className="answer">
                    We align to KPIs early, set baselines, and track benefits throughout delivery
                    with executive reviews.
                  </div>
                </details>
                <details>
                  <summary className="break-words">
                  ...
                  <div className="answer">
                    A co‑delivery model: decision cadence with execs, and hands‑on design with SMEs
                    to de‑risk change.
                  </div>
                </details>
              </div>
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            mainEntity: [
              {
                '@type': 'Question',
                name: 'Which domains do you specialize in?',
                acceptedAnswer: {
                  '@type': 'Answer',
                  text: 'Finance, healthcare, manufacturing, retail—and more.',
                },
              },
              {
                '@type': 'Question',
                ...
                acceptedAnswer: {
                  '@type': 'Answer',
                  text: 'KPIs aligned to objectives with regular reviews.',
                },
              },
              {
                '@type': 'Question',
                name: 'Can you work with our internal teams?',
                acceptedAnswer: {
                  '@type': 'Answer',
                  text: 'Yes—co‑delivery models with enablement and handover.',
                },
              },
            ],
          }),
